...
import { path } from "@arcana/core/effect/layer-node-platform"
...
import type { ProjectV2 } from "@arcana/core/project"
...
export class Service extends Context.Service<Service, Interface>()("@arcana/Worktree") {}
