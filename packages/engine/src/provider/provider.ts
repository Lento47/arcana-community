...
import { optionalOmitUndefined } from "@arcana/core/schema"
...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: any) => BundledSDK>> = {
  ...
  "@ai-sdk/github-copilot": () =>
    import("@arcana/core/github-copilot/copilot-provider").then((m) => m.createOpenaiCompatible),
...
export class Service extends Context.Service<Service, Interface>()("@arcana/Provider") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
      ...
      Effect.gen(function* () {
        ...
        for (const [id, provider] of Object.entries(providers)) {
          ...
          for (const [modelID, model] of Object.entries(provider.models)) {
            ...
            // [community] all tiers available; premium/go filtering removed
    ...
    const getSmallModel = Effect.fn("Provider.getSmallModel")(function* (providerID: ProviderV2.ID) {
      ...
      const priority = providerID.startsWith("arcana")
        ? ["gpt-5-nano"]
