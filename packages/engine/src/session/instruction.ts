...
export class Service extends Context.Service<Service, Interface>()("@arcana/Instruction") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const globalFiles = [
      ...
      path.join(global.config, "SOUL.md"),
    ]
    ...
    const systemPaths = Effect.fn("Instruction.systemPaths")(function* () {
      ...
      // SOUL.md always loaded separately — doesn't compete with AGENTS.md first-match-wins
      if (!Flag.ARCANA_DISABLE_PROJECT_CONFIG) {
