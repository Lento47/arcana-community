 ...
 *   "@arcana/ServerAuthConfig",
 *   {
 *     password: Config.string("ARCANA_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("ARCANA_SERVER_USERNAME").pipe(Config.withDefault("arcana")),
 *   },
 * ) {}
 *
