...
import { httpClient, path } from "@arcana/core/effect/layer-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@arcana/SkillDiscovery") {}
