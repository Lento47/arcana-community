...
import { ProjectDirectoryTable, ProjectTable } from "@arcana/core/project/sql"
...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@arcana/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@arcana/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.ARCANA_FAKE_VCS)
