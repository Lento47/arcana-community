...
import { EventSequenceTable, EventTable } from "@arcana/core/event/sql"
import { FSUtil } from "@arcana/core/fs-util"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { ProjectV2 } from "@arcana/core/project"
import { Slug } from "@arcana/core/util/slug"
...
export class Service extends Context.Service<Service, Interface>()("@arcana/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        ARCANA_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        ARCANA_WORKSPACE_ID: config.id,
        ARCANA_EXPERIMENTAL_WORKSPACES: "true",
