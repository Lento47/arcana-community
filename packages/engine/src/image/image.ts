...
export class Service extends Context.Service<Service, Interface>()("@arcana/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __ARCANA_PHOTON_WASM_PATH?: string }).__ARCANA_PHOTON_WASM_PATH =
