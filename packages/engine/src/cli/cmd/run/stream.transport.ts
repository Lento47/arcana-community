...
import type { Event, GlobalEvent, OpencodeClient } from "@arcana/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@arcana/RunStreamTransport") {}
