...
import type * as SDK from "@arcana/sdk/v2"
...
import { SessionShareTable } from "@arcana/core/share/sql"
import { ProviderV2 } from "@arcana/core/provider"
import { ModelV2 } from "@arcana/core/model"
import { EventV2 } from "@arcana/core/event"

const disabled = process.env["ARCANA_DISABLE_SHARE"] === "true" || process.env["ARCANA_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@arcana/ShareNext") {}
