...
import { errorData, errorMessage } from "@arcana/tui/util/error"
...
import { hasTheme, upsertTheme } from "@arcana/tui/context/theme"
import { Global } from "@arcana/core/global"
import { Filesystem } from "@/util/filesystem"
import { Process } from "@/util/process"
import { Flock } from "@arcana/core/util/flock"
import { Flag } from "@arcana/core/flag/flag"
import { internalTuiPlugins, type InternalTuiPlugin } from "./internal"
import type { HostPluginApi, HostSlots } from "@arcana/tui/plugin/slots"
import { ConfigPlugin } from "@/config/plugin"
import { ConfigPluginV1 } from "@arcana/core/v1/config/plugin"
import { createCommandShim } from "@arcana/tui/plugin/command-shim"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { Effect } from "effect"
import { createPluginRuntime, type PluginRuntime, type TuiPluginHost } from "@arcana/tui/plugin/runtime"
...
async function load(input: {
  ...
  try {
    ...
    const records = Flag.ARCANA_PURE ? [] : pluginOrigins
    if (Flag.ARCANA_PURE && pluginOrigins.length) {
    }
