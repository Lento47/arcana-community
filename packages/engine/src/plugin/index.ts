...
import { createOpencodeClient } from "@arcana/sdk"
...
import { InstallationChannel } from "@arcana/core/installation/version"
...
export class Service extends Context.Service<Service, Interface>()("@arcana/Plugin") {}
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("Plugin.state")(function* (ctx) {
        ...
        mark("plugin-boot-end")
        measure("plugin-boot-start", "plugin-boot-end", "plugin-boot")
