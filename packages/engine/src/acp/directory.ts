...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@arcana/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@arcana/ACPDirectory") {}
