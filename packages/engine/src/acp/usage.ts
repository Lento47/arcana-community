...
import type { AssistantMessage as OpenCodeAssistantMessage, Message } from "@arcana/sdk/v2"
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@arcana/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@arcana/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@arcana/ACPUsage") {}
