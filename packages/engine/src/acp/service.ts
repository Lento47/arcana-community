...
import type { Message, OpencodeClient, SessionMessageResponse } from "@arcana/sdk/v2"
...
export class Service extends Context.Service<Service, Interface>()("@arcana/ACP/Service") {}
...
function defaultModelFromConfig(
  ...
  const opencodeProvider = providers[ProviderV2.ID.make("arcana")]
