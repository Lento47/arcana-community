...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders ARCANA_CALLER", () => {
    process.env["ARCANA_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode ARCANA_CALLER", () => {
    process.env["ARCANA_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown ARCANA_CALLER", () => {
    process.env["ARCANA_CALLER"] = "unknown"
