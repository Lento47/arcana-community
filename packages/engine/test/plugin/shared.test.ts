...
describe("parsePluginSpecifier", () => {
  ...
  test("parses scoped npm package without version", () => {
    expect(parsePluginSpecifier("@arcana/acme")).toEqual({
      pkg: "@arcana/acme",
      version: "latest",
    })
  })
  ...
  test("parses scoped npm package with version", () => {
    expect(parsePluginSpecifier("@arcana/acme@1.0.0")).toEqual({
      pkg: "@arcana/acme",
      version: "1.0.0",
    })
  })
  ...
  test("parses scoped package with git+https url", () => {
    expect(parsePluginSpecifier("@arcana/acme@git+https://github.com/opencode/acme.git")).toEqual({
      pkg: "@arcana/acme",
      version: "git+https://github.com/opencode/acme.git",
    })
  })
  ...
  test("parses scoped package with git+ssh url containing another @", () => {
    expect(parsePluginSpecifier("@arcana/acme@git+ssh://git@github.com/opencode/acme.git")).toEqual({
      pkg: "@arcana/acme",
      version: "git+ssh://git@github.com/opencode/acme.git",
    })
  })
