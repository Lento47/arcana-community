...
import { APP_NAME, SOUND_PACK_NAME } from "./branding"
import type {
  TuiAttention,
...
} from "@arcana/plugin/tui"
import { AttentionSoundName, type TuiConfig } from "./config"
import { Schema } from "effect"
import stripAnsi from "strip-ansi"
import * as TuiAudio from "./audio"
// Audio imports — placeholders until arcana-branded sound pack is added.
// The audio system gracefully degrades if these files don't exist.
import defaultSoundPath from "../audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "../audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "../audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "../audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "../audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "../audio/yup-01.mp3" with { type: "file" }
