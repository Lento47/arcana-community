import { createContext, useContext, type ParentProps, Show, Switch, Match } from "solid-js"
    ...
    <Show when={toast.currentToast}>
      {(current) => (
        ...
        >
          ...
          <Switch>
            <Match when={current().variant === "error"}>
              <Scramble error text={current().message} fg={theme.error} />
            </Match>
            <Match when={true}>
