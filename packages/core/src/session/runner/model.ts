...
import { type Model } from "@arcana/llm"
import * as AnthropicMessages from "@arcana/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@arcana/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@arcana/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@arcana/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@arcana/v2/SessionRunnerModel") {}
