...
export class OpenAICompatibleChatLanguageModel implements LanguageModelV3 {
  ...
  // typed as implicit any — ERROR_SCHEMA generic makes full inference infeasible
  // without making the class generic. Success-path properties work via inference;
  // error branch requires runtime discrimination ("error" in value).
