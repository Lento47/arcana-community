...
declare const ARCANA_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof ARCANA_LIBC === "undefined" ? undefined : ARCANA_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@arcana/v2/FileWatcher") {}

export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.ARCANA_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.ARCANA_EXPERIMENTAL_FILEWATCHER) {
