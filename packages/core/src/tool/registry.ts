...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@arcana/llm"
...
export class Service extends Context.Service<Service, Interface>()("@arcana/v2/ToolRegistry") {}
