...
import type { EffectDrizzleSqlite } from "@arcana/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@arcana/ProjectDirectories") {}
