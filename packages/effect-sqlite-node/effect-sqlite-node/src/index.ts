...
export const TypeId: TypeId = "~@arcana/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@arcana/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@arcana/effect-sqlite-node/NodeSqliteClient")
