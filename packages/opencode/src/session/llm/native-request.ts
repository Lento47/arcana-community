import type { JsonSchema, LLMRequest, ProviderMetadata } from "@arcana/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@arcana/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @arcana/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
