import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@arcana/llm"
...
// Move this extraction into @arcana/llm when Copilot is handled by the native runtime.
