...
class Database extends Context.Service<Database, DatabaseShape>()("@arcana/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@arcana/example/UserStore") {
